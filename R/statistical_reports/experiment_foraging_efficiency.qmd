...
bite_steps <- read_csv(here("data/clean/foraging_efficiency/yak_bite_steps_ratio.csv"))

# Define a function to load model data for a plant group
load_bite_step_data <- function(plant) {
  base_path <- here(glue::glue("data/clean/foraging_efficiency/bite_steps_ratio/{plant}"))
...
# Load the bite_steps dataset once
plant_bites <- read_csv(here("data/clean/foraging_efficiency/yak_plant_bites.csv")) |>
  mutate(plant = gsub("_[^_]*$", '',plant))

# Define a function to load model data for a plant group
load_plant_bites_data <- function(plant) {
  base_path <- here(glue::glue("data/clean/foraging_efficiency/plant_bites/{plant}"))
...
weight_gain <- read_csv(here("data/clean/foraging_efficiency/yak_weight_gain.csv")) |>
...
weight_gain_models <- load_data(here('data/clean/foraging_efficiency/weight_gain'))
```
