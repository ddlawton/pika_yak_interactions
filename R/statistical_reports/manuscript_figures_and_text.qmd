...
get_family_info <- function(model) {
  ...
  # Format family name
  if (grepl("tweedie", family_name, ignore.case = TRUE)) {
    ...
    return(list(family = "Tweedie", tweedie_power = tweedie_power))
  } else if (grepl("beta", family_name, ignore.case = TRUE)) {
    return(list(family = "Beta", tweedie_power = NA_real_))
  } else if (grepl("gaussian", family_name, ignore.case = TRUE)) {
    return(list(family = "Gaussian", tweedie_power = NA_real_))
  } else if (grepl("binomial", family_name, ignore.case = TRUE)) {
    return(list(family = "Binomial", tweedie_power = NA_real_))
  } else {
    return(list(family = family_name, tweedie_power = NA_real_))
  }
}
