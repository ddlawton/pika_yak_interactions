...
(CP) content, (H) acid detergent fibre (ADF) content, and (I) neutral detergent fibre
(NDF) of total forage (dry mass basis). Average values from both years were used in
...
Model contrasts for weight gain, grass cover, S. chamaejasme cover, crude protein %, acid detergent fibre %, and neutral detergent fiber %.
:::
