...
# Plot G and H: burrow count and weight gain x burrow count relationship

panel_g <- ggplot(act_burrow_count_dat, aes(x = pika_treatment, y = active_burrows, 
  color = posion_plant_treatment)) +
    geom_jitter(
    size = 1, alpha = 0.4,
    position = position_jitterdodge(jitter.width = 0.2, dodge.width = 0.7)
