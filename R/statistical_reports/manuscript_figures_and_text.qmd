...
Food quantity and quality are key drivers of individual performance and population dynamics of large herbivores^30-32^. In the presence of *S. chamaejasme* forbs, pika doubled the cover of yak’s most favored grasses (@fig-2 C, @supptbl-grass-cover-model-summary, @supptbl-grass-cover-contrasts) and increased crude protein content of total forage by approximately 14% (@fig-2 D, @supptbl-cp-model-summary, @supptbl-cp-model-contrasts), suggesting that pika facilitate yak by increasing the quantity and quality of forage plants. Acid detergent fibre and ether extract were also sigificantly different between the plots (@fig-2 E & F). The increases in grass abundance and forage quality were likely driven by the decline in poisonous plant abundance induced by pika (@fig-2 B), which released inter-specific competition for shared resources (e.g., light, soil moisture and nutrients) and allowed their growth and expansion^27-28^. In the absence of *S. chamaejasme* forbs, however, the positive effects of pika on food resources and weight gain of yak disappeared (@fig-2 A,C,D). Pika and poisonous plants impacted sedge cover similiarly like grass cover (@suppfig-forb-sedge-cover A) and there was a more complicated interaction with forb cover (@suppfig-forb-sedge-cover B). There was no impact of pika and poisonous plant on neutrl detergent fibre (@fig-2 C).
...
Diet selection of pika and yak and their potential interactions mediated by poisonous plants in the field surveys in July 2021. (a) Feeding and clipping frequency of pika, and (b) grazing frequency of yak on the S. chamaejasme, sedges, grasses, and forbs in the 10 2 m × 2 m plots and the 10 250 m transects, respectively. 
(c) The relationship between active pika burrow density and S. chamaejasme cover, and (d) the relationship between S. chamaejasme cover and yak grazing activity in the 30 10 m × 10 m plots. (e) Two yak were grazing around the poisonous S. chamaejasme during its flowering season (i.e., May to June) in the study site. 
...
::: {#suppfig-forb-sedge-cover}

```{r suppfig-forb-sedge-cover}
#| echo: false
#| results: asis
#| message: false
#| warning: false
...
Forb and Sedge cover within pika and *S. chamaejasme* plots.
:::
...
```{r reading in step and bite data}
#| echo: false
#| message: false
#| warning: false
...
::: {supptbl-grass-bite-step-summary} 
```{r grass bite step summary}
#| echo: false
#| message: false
#| warning: false
...
```
Model summary for yak grass bite steps.
:::

::: {supptbl-grass-bite-step-contrast} 
```{r grass bite step contrast}
#| echo: false
#| message: false
#| warning: false
...
```
Estimated marginal means contrasts for grass bite/steps by treatment group.
:::

::: {supptbl-sedges-bite-step-summary} 
```{r sedge bite step summary}
#| echo: false
#| message: false
#| warning: false
...
bite_step_models$sedges$model_summary |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for sedge bite/steps.
:::


::: {supptbl-sedges-bite-step-contrast} 
```{r sedge bit step contrast}
#| echo: false
#| message: false
#| warning: false
...
::: {supptbl-forb-bite-step-summary} 
```{r forb bite step summary}
#| echo: false
#| message: false
#| warning: false
...
bite_step_models$forbs$model_summary  |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for forb bite/steps.
:::

::: {supptbl-forb-bite-step-contrast} 
```{r forb bite step contrast}
#| echo: false
#| message: false
#| warning: false
#| 
bite_step_models$forbs$model_contrasts |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Estimated marginal means contrasts for forbs bite/steps by treatment group.
:::



::: {supptbl-grasses-bite-summary} 
```{r grass bite summary}
#| echo: false
#| message: false
#| warning: false
#| 
plant_bites_models$grasses$model_summary  |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for grass bites.
:::

::: {supptbl-grasses-bite-contrast} 
```{r grass bite contrast}
#| echo: false
#| message: false
#| warning: false
plant_bites_models$grasses$model_contrasts |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Estimated marginal means contrasts for grass bites by treatment group.
:::


::: {supptbl-forbs-bite-summary} 
```{r forb bite summary}
#| echo: false
#| message: false
#| warning: false
...
plant_bites_models$forbs$model_summary  |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for forbs bites.
:::

::: {supptbl-forbs-bite-contrast} 
```{r forb bite contrast}
#| echo: false
#| message: false
#| warning: false
plant_bites_models$forbs$model_contrasts |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Estimated marginal means contrasts for forbs bites by treatment group.
:::



::: {supptbl-sedges-bite-summary} 
```{r sedge bite summary}
#| echo: false
#| message: false
#| warning: false
#| 
plant_bites_models$sedges$model_summary  |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for sedges bites.
:::

::: {supptbl-sedges-bite-contrast} 
```{r sedge bite contrast}
#| echo: false
#| message: false
#| warning: false
plant_bites_models$sedges$model_contrasts |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Estimated marginal means contrasts for sedges bites by treatment group.
:::


::: {supptbl-total-bite-summary} 
```{r total bite summary}
#| echo: false
#| message: false
#| warning: false
#| 
plant_bites_models$total$model_summary  |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Model summary for total bites.
:::

::: {supptbl-total-bite-contrast} 
```{r total bite contrast}
#| echo: false
#| message: false
#| warning: false
plant_bites_models$total$model_contrasts |>
  ...
  kable_styling(latex_options = c("striped","scale_down"))
```
Estimated marginal means contrasts for total bites by treatment group.
::: -->
