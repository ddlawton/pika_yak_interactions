...
Model summary for yak weight gain regressed on active burrow count. Estimates are from a generalized additive mixed model (Gaussian family) with block, year, and month as random effects (n = `r n_experiment_plots` plots).
:::
...
model_overview <- tibble::tribble(
  ~Analysis, ~`Response Variable`, ~`Model Type`, ~`Distribution/Family`, ~`Random Effects`, ~`Sample Size`,
  
  # Field surveys (2021)
  "Diet selection", "Pika feeding frequency", "GLMM", "Beta", "plot, month", glue("n = {n_pika_plots} plots"),
  "Diet selection", "Yak grazing frequency", "GLMM", "Beta", "transect, month", glue("n = {n_yak_transects} transects"),
  "Diet selection", "S. chamaejasme cover vs burrow density", "GAM", "Gaussian", "plot", glue("n = {n_burrow_dung_plots} plots"),
  "Diet selection", "Dung density vs S. chamaejasme cover", "LM", "Gaussian", "none", glue("n = {n_burrow_dung_plots} plots"),
  
  # Field experiments (2022-2023)
  "Yak performance", "Weight gain", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Yak performance", "Weight gain vs burrow density", "GAM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots"),
  "Plant cover", "Grass cover", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Plant cover", "Sedge cover", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Plant cover", "Forb cover", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Plant cover", "S. chamaejasme cover", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Plant cover", "Active burrow density", "GLMM", "Tweedie", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Forage quality", "Crude protein (%)", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Forage quality", "Acid detergent fiber (%)", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Forage quality", "Neutral detergent fiber (%)", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Sedge bite rate", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Grass bite rate", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Forb bite rate", "GLMM", "Gaussian", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Sedge bites/step", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Grass bites/step", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years"),
  "Foraging efficiency", "Forb bites/step", "GLMM", "Beta", "block, year, month", glue("n = {n_experiment_plots} plots, {n_years_experiment} years")
)
...
model_overview |>
  ...
  tab_footnote(
    footnote = "GLMM = Generalized Linear Mixed Model; GAM = Generalized Additive Mixed Model; LM = Linear Model"
  ) |>
  opt_stylize(style = 6, color = "gray")

```

Summary of all statistical models used in the study, including model type, distribution family, random effects structure, and sample sizes. All field experiments (2022-2023) used a 2×2 factorial design with pika presence/absence and S. chamaejasme presence/absence treatments.
:::