---
title: "Plant Cover: Exploratory Analysis"
...
This report documents the exploratory analysis of plant cover data that informed the final manuscript analyses. The finalized methods, results, and figures are presented in the **Methods and Results** document.
:::
...
#| message: false
#| warning: false
cover_data <- read_csv(here('data/clean/plant_cover/plant_cover_by_treatment.csv'))

forbs_emms <- read_csv(here('data/clean/plant_cover/forbs/emms.csv'))
forbs_letters <- read_csv(here('data/clean/plant_cover/forbs/posthoc_letters.csv'))
forbs_model_summary  <- read_csv(here('data/clean/plant_cover/forbs/model_summary.csv'))
forbs_model_contrasts  <- read_csv(here('data/clean/plant_cover/forbs/posthoc_contrasts.csv'))

grasses_emms <- read_csv(here('data/clean/plant_cover/grasses/emms.csv'))
grasses_letters <- read_csv(here('data/clean/plant_cover/grasses/posthoc_letters.csv'))
grasses_model_summary  <- read_csv(here('data/clean/plant_cover/grasses/model_summary.csv'))
grasses_model_contrasts  <- read_csv(here('data/clean/plant_cover/grasses/posthoc_contrasts.csv'))

poison_emms <- read_csv(here('data/clean/plant_cover/s_chamaejasme/emms.csv'))
poison_letters <- read_csv(here('data/clean/plant_cover/s_chamaejasme/posthoc_letters.csv'))
poison_model_summary  <- read_csv(here('data/clean/plant_cover/s_chamaejasme/model_summary.csv'))
poison__model_contrasts  <- read_csv(here('data/clean/plant_cover/s_chamaejasme/posthoc_contrasts.csv'))

sedges_emms <- read_csv(here('data/clean/plant_cover/sedges/emms.csv'))
sedges_letters <- read_csv(here('data/clean/plant_cover/sedges/posthoc_letters.csv'))
sedges_model_summary  <- read_csv(here('data/clean/plant_cover/sedges/model_summary.csv'))
sedges_model_contrasts  <- read_csv(here('data/clean/plant_cover/sedges/posthoc_contrasts.csv'))
