---
title: "Forage Quality: Exploratory Analysis"
...
This report documents the exploratory analysis of forage quality data that informed the final manuscript analyses. The finalized methods, results, and figures are presented in the **Methods and Results** document.
:::
...
forage_quality <- read_csv(here("data/clean/forage_quality/plant_forage_quality.csv"))

# Define a function to load model data for a plant group
load_forage_quality_data <- function(quality_metric) {
  base_path <- here(glue::glue("data/clean/forage_quality/{quality_metric}"))

  # Helper: safely load CSV, return NULL if missing (e.g., GAM models lack emmeans)
...
(adf_plot + cp_plot) / (ndf_plot + plot_spacer()) + 
